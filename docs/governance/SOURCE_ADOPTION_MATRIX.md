...
| `PENDING_CLASSIFICATION` | 49 | Existing URL requiring primary-source understanding before any new use. |
...
| [https://github.com/PyCQA/pycodestyle](https://github.com/PyCQA/pycodestyle) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
...
| [https://github.com/css-modules/css-modules](https://github.com/css-modules/css-modules) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
| [https://github.com/css-modules/postcss-modules-values](https://github.com/css-modules/postcss-modules-values) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
| [https://github.com/csstools/postcss-nesting](https://github.com/csstools/postcss-nesting) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
...
| [https://github.com/koalaman/shellcheck](https://github.com/koalaman/shellcheck) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
...
| [https://github.com/mdn/browser-compat-data](https://github.com/mdn/browser-compat-data) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
...
| [https://github.com/minlan-yu/cs145-site](https://github.com/minlan-yu/cs145-site) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
| [https://github.com/minlan-yu/cs243-site.](https://github.com/minlan-yu/cs243-site.) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
...
| [https://github.com/postcss/postcss-custom-media](https://github.com/postcss/postcss-custom-media) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
| [https://github.com/postcss/postcss-custom-selectors](https://github.com/postcss/postcss-custom-selectors) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
| [https://github.com/postcss/postcss-media-minmax](https://github.com/postcss/postcss-media-minmax) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
| [https://github.com/postcss/postcss-nested](https://github.com/postcss/postcss-nested) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
...
| [https://github.com/webpack/webpack](https://github.com/webpack/webpack) | `PENDING_CLASSIFICATION` | لم يُستخرج الغرض بعد من مصدر أولي؛ لا يجوز للوكيل افتراضه من اسم الرابط أو موضعه فقط. | — |
