...
|---|---|---|---|
| [https://github.com/ByteByteGoHq/system-design-101](https://github.com/ByteByteGoHq/system-design-101) | mandatory_reference_backbone | `system-design-101` | `docs/governance/REFERENCE_BACKBONE.json`, `docs/governance/REFERENCE_BACKBONE.md` |
| [https://github.com/CharlesQ9/Self-Evolving-Agents](https://github.com/CharlesQ9/Self-Evolving-Agents) | other_repository_reference_or_dependency | `unclassified` | `Introduction to Agents.pdf` |
| [https://github.com/ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | mandatory_reference_backbone | `awesome-claude-skills` | `docs/governance/REFERENCE_BACKBONE.json`, `docs/governance/REFERENCE_BACKBONE.md` |
| [https://github.com/EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) | mandatory_reference_backbone | `free-programming-books` | `docs/governance/REFERENCE_BACKBONE.json`, `docs/governance/REFERENCE_BACKBONE.md` |
...
| [https://github.com/astral-sh/ruff-pre-commit](https://github.com/astral-sh/ruff-pre-commit) | other_repository_reference_or_dependency | `unclassified` | `.pre-commit-config.yaml`, `tests/fitness/test_delivery_standards_gates.py` |
| [https://github.com/bakabala27-svg/NAAS-Agentic-Core](https://github.com/bakabala27-svg/NAAS-Agentic-Core) | other_repository_reference_or_dependency | `unclassified` | `docs/research/authoritative-foundations.md` |
| [https://github.com/browser-use/browser-use](https://github.com/browser-use/browser-use) | mandatory_reference_backbone | `browser-use` | `docs/governance/REFERENCE_BACKBONE.json`, `docs/governance/REFERENCE_BACKBONE.md` |
| [https://github.com/cert-manager/cert-manager](https://github.com/cert-manager/cert-manager) | other_repository_reference_or_dependency | `unclassified` | `docs/DEPLOYMENT_GUIDE.md` |
| [https://github.com/chalk/ansi-regex](https://github.com/chalk/ansi-regex) | other_repository_reference_or_dependency | `unclassified` | `frontend/package-lock.json` |
| [https://github.com/chalk/ansi-styles](https://github.com/chalk/ansi-styles) | other_repository_reference_or_dependency | `unclassified` | `frontend/package-lock.json` |
| [https://github.com/chalk/chalk](https://github.com/chalk/chalk) | other_repository_reference_or_dependency | `unclassified` | `frontend/package-lock.json` |
| [https://github.com/chalk/strip-ansi](https://github.com/chalk/strip-ansi) | other_repository_reference_or_dependency | `unclassified` | `frontend/package-lock.json` |
| [https://github.com/chalk/wrap-ansi](https://github.com/chalk/wrap-ansi) | other_repository_reference_or_dependency | `unclassified` | `frontend/package-lock.json` |
| [https://github.com/cncf/trailmap](https://github.com/cncf/trailmap) | other_repository_reference_or_dependency | `unclassified` | `docs/adr/ADR-002-microservices-architecture.md` |
...
| [https://github.com/donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | mandatory_reference_backbone | `system-design-primer` | `docs/governance/REFERENCE_BACKBONE.json`, `docs/governance/REFERENCE_BACKBONE.md` |
| [https://github.com/fb55/entities](https://github.com/fb55/entities) | other_repository_reference_or_dependency | `unclassified` | `frontend/package-lock.json` |
| [https://github.com/freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | mandatory_reference_backbone | `freecodecamp` | `docs/governance/REFERENCE_BACKBONE.json`, `docs/governance/REFERENCE_BACKBONE.md` |
| [https://github.com/github/github-mcp-server](https://github.com/github/github-mcp-server) | other_repository_reference_or_dependency | `unclassified` | `.cursor/mcp.json`, `.vscode/mcp-settings.json` |
| [https://github.com/google-gemini/cookbook](https://github.com/google-gemini/cookbook) | external_standards_registry | `gemini-cookbook:ABSENT` | `docs/governance/EXTERNAL_STANDARDS_REGISTRY.json` |
| [https://github.com/google/A2UI](https://github.com/google/A2UI) | other_repository_reference_or_dependency | `unclassified` | `Introduction to Agents.pdf` |
| [https://github.com/google/adk-python](https://github.com/google/adk-python) | external_standards_registry | `google-adk-python:SEAM` | `docs/governance/EXTERNAL_STANDARDS_REGISTRY.json` |
...
| [https://github.com/privatenumber/resolve-pkg-maps](https://github.com/privatenumber/resolve-pkg-maps) | other_repository_reference_or_dependency | `unclassified` | `frontend/package-lock.json` |
| [https://github.com/prometheus/prometheus](https://github.com/prometheus/prometheus) | other_repository_reference_or_dependency | `unclassified` | `Dockerfile` |
| [https://github.com/psf/black](https://github.com/psf/black) | other_repository_reference_or_dependency | `unclassified` | `tests/fitness/test_delivery_standards_gates.py` |
| [https://github.com/public-apis/public-apis](https://github.com/public-apis/public-apis) | mandatory_reference_backbone | `public-apis` | `docs/governance/REFERENCE_BACKBONE.json`, `docs/governance/REFERENCE_BACKBONE.md` |
