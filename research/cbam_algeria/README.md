...
| `Contact_Plan_AR.docx` | Internal | Operational contact plan: honest odds assessment, the three counterparts in order (Green and Fair → CRE Annaba → Minister), CRE contact details, ready-to-send French letter to Prof. Bouslama, alternative-verifier comparison |
