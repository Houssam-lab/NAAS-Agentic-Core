...
# (متّجه العنوان مشترك و**لا يقفل إطلاقاً** — يُبطِئ فقط، القاعدة 10؛ فأقصى ما
# تدفعه السيناريوهات أدناه ثوانٍ، لا منعاً.)
...
# ٢٣ عقد انحدار (تفشل على الكود القديم — شرط الإغلاق)
