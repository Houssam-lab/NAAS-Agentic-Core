...
4. **الفارض بمرمىً أضيق من قاعدته ليس فارضاً** (تكرار ISS-148): `check_model_chain_parity`
   ...
   ولا نشرةَ تتجاوزه. ⛔ **القرار الواحد له موطنٌ واحد**، والبوّابة تُوسَّع لتشمل كل من
   يحمله.
...
**النتيجة:** `336→39` سطراً · `51→2` تعقيداً · `13→1` عمقاً · `routes.py` `1566→1272`.
والغلاف الرفيع صار: صادِق ⇒ ابنِ الدور ⇒ اختر البثّ ⇒ أعِده.
...
7. **الفارض في مسار الدمج لا في تقريرٍ خارجي:** CodeScene خدمةٌ تصل بعد الدمج ولا
   ...
   التوأمَين فلا ينموان) · ميزانية الوافد الجديد — و**ثماني تجارب سلبية مُثبَتة**
   لأن حارساً لا يُثبَت أنه يصرخ ليس حارساً («الثمن الثالث» — D-207).
