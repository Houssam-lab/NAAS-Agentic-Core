...
موطنٌ واحد (D-186). **الفارض:** `check_model_chain_parity` وُسِّع ليرفض أيّ حرفية نموذج
في عملاء النماذج، بتجربةٍ سلبية مُثبَتة (أُعيدت الحرفية ⇒ أحمر، أُزيلت ⇒ أخضر).
...
## ISS-155 (2026-08-11) — التوأمان في `routes.py`: ازدواجٌ مقيس على **مسار الطالب الحيّ** — 🔶 مفتوح (مؤجَّل بقرار)
